...
TITLE MetalMueble MRP II - FlexSim 2027 - V23 COLAS EN CUADRICULA
...
if not defined FLEX (
  echo [ERROR] No encontre flexsim.exe de FlexSim 2027.
  pause
  exit /b 1
)
...
if not exist "%SEED%" (
  echo Descargando modelo oficial HelloWorld.fsm de FlexSim...
...
echo ================================================================
echo   METALMUEBLE V23 - COLAS EN CUADRICULA
echo ================================================================
echo.
echo Se conserva exactamente toda la logica funcional de V22.
echo Las 420 piezas se liberan durante los primeros 25.14 segundos simulados.
echo Los bloques ocupan el area de cada cola en filas, columnas y capas.
echo No se cambian tiempos, capacidades, conexiones ni KPIs.
echo.
